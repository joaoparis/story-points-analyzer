...
_VARS: list[tuple[str, str, bool]] = [
    ("JIRA_BASE_URL", "Jira base URL (e.g. https://atc.bmwgroup.net/jira)", True),
    ("JIRA_TOKEN", "Jira personal access token", True),
    ("CONFLUENCE_BASE_URL", "Confluence base URL (e.g. https://atc.bmwgroup.net/confluence)", True),
    ("CONFLUENCE_TOKEN", "Confluence personal access token", True),
    ("CONFLUENCE_PARENT_PAGE_ID", "Confluence parent page ID (numeric)", True),
    ("JIRA_PROJECT", "Jira project key to limit scope (optional, e.g. NWAP)", False),
